    ...
    <main className="min-h-screen bg-yellow-50">
      <header className="sticky top-0 z-20 border-b border-pink-100 bg-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
          <div>
            ...
            <h1 className=" text-xl text-stone-800" style={{ fontFamily: "var(--font-heading), sans-serif", lineHeight: 1.2 }}>
              {customer.name}
            </h1>
          </div>
      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        <div className="mb-8">
          ...
          <h2 className=" text-3xl font-bold text-stone-800" style={{ fontFamily: "var(--font-heading), sans-serif", lineHeight: 1.2 }}>
